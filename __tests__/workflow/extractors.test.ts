...
import { extractCertificateFromXml, extractValueFromPath } from '@/app/lib/workflow/extractors';

describe('Workflow extractors', () => {
  let xml: string;

  beforeAll(() => {
    const file = path.join(__dirname, '../fixtures/public/federationmetadata.xml');
